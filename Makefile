...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sat Feb 22 11:42:51 2014
# Project:  rcg_player.pro
# Template: subdirs
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++-64 -o Makefile rcg_player.pro
#############################################################################
...
rcg//$(MAKEFILE): 
	...
	cd rcg/ && $(QMAKE) /home/baj/Dropbox/Workspace/rcg_player/rcg/rcg.pro -spec /usr/share/qt4/mkspecs/linux-g++-64 -o $(MAKEFILE)
...
qt4//$(MAKEFILE): 
	...
	cd qt4/ && $(QMAKE) /home/baj/Dropbox/Workspace/rcg_player/qt4/qt4.pro -spec /usr/share/qt4/mkspecs/linux-g++-64 -o $(MAKEFILE)
...
rcg_logger//$(MAKEFILE): 
	...
	cd rcg_logger/ && $(QMAKE) /home/baj/Dropbox/Workspace/rcg_player/rcg_logger/rcg_logger.pro -spec /usr/share/qt4/mkspecs/linux-g++-64 -o $(MAKEFILE)
...
Makefile: rcg_player.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++-64 -o Makefile rcg_player.pro
